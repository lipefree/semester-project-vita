...
class CVM_VIGOR(nn.Module):
    ...
    def forward(self, grd, sat, osm):
        ...
        fuse_feature_block0 = self.pyramid_conv0(fused_output)
        fuse_feature_block2 = self.pyramid_conv1(fused_output)
        fuse_feature_block4 = self.pyramid_conv2(fused_output)
        fuse_feature_block10 = self.pyramid_conv3(fused_output)
        fuse_feature_block15 = self.pyramid_conv4(fused_output)
