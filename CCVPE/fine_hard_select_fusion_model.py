...
class CVM_VIGOR(nn.Module):
    def __init__(
        ...
        self.router_volume = PatchRouter(1280 * 1 * 1, patch_size=1)
        self.router15 = PatchRouter(320 * 1 * 1, patch_size=1)
        self.router10 = PatchRouter(112 * 2 * 2, patch_size=2)
        self.router4 = PatchRouter(40 * 4 * 4, patch_size=4)
        self.router2 = PatchRouter(24 * 8 * 8, patch_size=8)
        self.router0 = PatchRouter(16 * 16 * 16, patch_size=16)
