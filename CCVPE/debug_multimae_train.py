...
from model_utils.criterion import MaskedMSELoss
...
label = 'multimae_fusion_encoder_3_branch_masked_debug'
...
if training is True:
    ...
    # train_indices = index_list[0: int(len(index_list)*0.0001)]
    train_indices = index_list[0: 2]
    ...
    for epoch in range(150):  # loop over the dataset multiple times
        ...
        for i, data in enumerate(train_dataloader, 0):
            ...
            if use_fusion_loss:
                ...
                print('recons size ', recons_osm.size())
                print('target size ', osm.size())
        ...
        with torch.no_grad(): # fix this
            ...
            for i, data in enumerate(val_dataloader, 0):
                ...
                if use_fusion_loss:
                    ...
                    loss_osm = masked_mse_loss(recons_osm, osm, mask=masks['osm'])
