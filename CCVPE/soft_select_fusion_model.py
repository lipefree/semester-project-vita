...
class CVM_VIGOR(nn.Module):
    def __init__(
        ...
        self.router_volume = PatchRouter(1280 * 16 * 16)
        self.router15 = PatchRouter(320 * 16 * 16)
        self.router10 = PatchRouter(112 * 16 * 16)
        self.router4 = PatchRouter(40 * 16 * 16)
        self.router2 = PatchRouter(24 * 16 * 16)
        self.router0 = PatchRouter(16 * 16 * 16)
