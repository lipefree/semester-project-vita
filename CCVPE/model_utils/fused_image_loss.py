# File from : https://github.com/millieXie/FusionMamba/blob/main/loss.py

import torch
import torch.nn as nn
import torch.nn.functional as F

from model_utils.pytorch_msssim import msssim
...
class Fusionloss(nn.Module):
    ...
    def forward(self,image_vis,image_ir,labels,generate_img,i):
        image_y = self.rgb_to_grayscale(image_vis)
        image_ir = self.rgb_to_grayscale(image_ir)
        generate_img = self.rgb_to_grayscale(generate_img)
