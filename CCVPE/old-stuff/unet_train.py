...
from unet_model import CVM_VIGOR as CVM
...
if training is True:
    ...
    # we can also load sub set according to a max dist : dist_sub_1.npy  dist_sub_2.npy  dist_sub_3.npy  dist_sub_5.npy  dist_sub_9.npy
