...
from model_utils.deformable_fusion import deformable_cross_attention, deformable_fusion
...
class CVM_VIGOR(nn.Module):
    def __init__(self, device, circular_padding, use_adapt, use_concat, use_mlp=False):
        ...
        self.cross_da1 = deformable_cross_attention(self.device)
    ...
    def forward(self, grd, sat, osm):
        ...
        (
            ...
            fuse_feature_volume,
        ) = self.deformable_fusion(sat_features, osm_features, batch_size)
