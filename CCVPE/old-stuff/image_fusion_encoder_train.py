...
from image_fusion_encoder_model import CVM_VIGOR as CVM
...
parser.add_argument('-l', '--learning_rate', type=float, help='learning rate', default=3e-4)
...
label = 'fused_image_encoder_v2_concat_skip'
