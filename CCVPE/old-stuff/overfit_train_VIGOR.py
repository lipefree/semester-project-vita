...
parser.add_argument(
    "--area", type=str, help="samearea or crossarea", default="samearea"
)
parser.add_argument("--training", choices=("True", "False"), default="True")
parser.add_argument("--pos_only", choices=("True", "False"), default="True")
parser.add_argument(
    "-l", "--learning_rate", type=float, help="learning rate", default=1e-4
)
parser.add_argument("-b", "--batch_size", type=int, help="batch size", default=8)
parser.add_argument(
    "--weight_ori", type=float, help="weight on orientation loss", default=1e1
)
parser.add_argument(
    "--weight_infoNCE", type=float, help="weight on infoNCE loss", default=1e4
)
parser.add_argument("-f", "--FoV", type=int, help="field of view", default=360)
parser.add_argument(
    "--ori_noise",
    type=float,
    help="noise in orientation prior, 180 means unknown orientation",
    default=180.0,
)
...
if (
    training is False and ori_noise == 180
):  # load pre-defined random orientation for testing
    if area == "samearea":
...
if training:
    ...
    for epoch in range(300):  # loop over the dataset multiple times
        ...
        writer.add_scalar(
            "Validation/mean_orientation_error", median_orientation_error, epoch
        )
