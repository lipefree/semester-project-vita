...
class L2Wrapper():
    def __init__(self, experiment_name, device, weight_infoNCE=1e4, weight_ori=1e1, alpha_type=2, use_fusion_loss=False, l2_weight=10e5):
    ...
    def validation_step(self, data, validation_state):
        ...
        validation_state['loss_l2'].append(losses[1].item())
    ...
    def validation_log(self, validation_state, epoch, writer):
        ...
        loss_l2 = np.mean(validation_state['loss_l2'])
        ...
        self.log_loss('Validation', epoch,
                        writer, loss, loss_l2, loss_infonce, 
    ...
    def compute_loss(self, output, gt, gt_orientation, gt_with_ori, osm, sat):
        ...
        loss_l2 = self.l2_weight*self.l2_loss(logits_flattened, gt_flattened)
        loss = loss_l2 + loss_infonce + loss_ori
        ...
        return loss, loss_l2, loss_infonce, loss_ori, loss_fusion


    def log_loss(self, stage_name, global_step, writer, loss, loss_l2, loss_infonce, loss_ori, loss_fusion):
        writer.add_scalar(f"{stage_name}/loss_l2", loss_l2, global_step)
