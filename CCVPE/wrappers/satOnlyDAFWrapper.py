...
class SatOnlyDAFWrapper():
    def __init__(self, experiment_name, device, weight_infoNCE=1e4, weight_ori=1e1, alpha_type=2, use_fusion_loss=False, pretrained=False, double_input=False):
        ...
        if pretrained:
            ...
            deformable_fusion_name, epoch = ('fused_image_ccvpe_alpha2', 5)
            epoch = str(epoch)
            model_path = os.path.join(base_model_path, deformable_fusion_name, epoch, "model.pt")
