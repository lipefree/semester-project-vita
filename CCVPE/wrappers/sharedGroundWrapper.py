from shared_ground_fusion_model import CVM_VIGOR as CVM
...
class SharedGroundWrapper():
    def __init__(self, experiment_name, device, weight_infoNCE=1e4, weight_ori=1e1, use_fusion_loss=False):
