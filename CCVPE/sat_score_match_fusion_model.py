...
class CVM_VIGOR(nn.Module):
    ...
    def forward(self, grd, sat):
        ...
        fuse_descriptor_map = self.fusion_volume(f_score, sat_descriptor_map)
    ...
    def localization_decoder(
        ...
        if fuse_feature_block is not None:
            da_output = self.fusions[level](matching_score_stacked, fuse_feature_block)
