...
class VIGORDataset(Dataset):
    def __init__(
            self, root, label_root = 'splits_new', split='samearea', 
            train=True, transform=None, pos_only=True, ori_noise=180, 
            random_orientation=None, use_osm_tiles=True
        ):
        self.root = root
        ...
        self.use_osm_tiles = use_osm_tiles
